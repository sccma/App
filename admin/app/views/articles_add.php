...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<script id="container" name="article_content" type="text/plain" style="width:98%; height:318px;"></script>
	...
	<div class="layui-inline">
		...
		<div class="layui-input-block">
			<select name="article_status">
	        	<option value="1">|_ 展示</option>
	        	<option value="2">|_ 关闭</option>
	        </select>
		</div>
	</div>
</div>
<div class="layui-form-item">
	<div class="layui-input-block">
		<button class="layui-btn" id="graceSubBtn" lay-submit="" lay-filter="*">添加文章</button>
	</div>
</div>
</form>
